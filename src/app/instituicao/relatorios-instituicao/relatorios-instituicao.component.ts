...
@Component({
  selector: 'app-relatorios-instituicao',
  templateUrl: './relatorios-instituicao.component.html',
  styleUrls: ['./relatorios-instituicao.component.css']
})
export class RelatoriosInstituicaoComponent {
  searchQuery: string = '';
